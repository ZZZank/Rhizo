...
final class NativeDate extends IdScriptableObject {
	...
	protected int findPrototypeId(String s) {
		switch (s) {
			...
			case "toTimeString": return Id_toTimeString;
			case "toDateString": return Id_toDateString;
			case "toLocaleString": return Id_toLocaleString;
			case "toLocaleTimeString": return Id_toLocaleTimeString;
			case "toLocaleDateString": return Id_toLocaleDateString;
			case "toUTCString": return Id_toUTCString;
			case "toSource": return Id_toSource;
			case "valueOf": return Id_valueOf;
			case "getTime": return Id_getTime;
			case "getYear": return Id_getYear;
			case "getFullYear": return Id_getFullYear;
			case "getUTCFullYear": return Id_getUTCFullYear;
			case "getMonth": return Id_getMonth;
			case "getUTCMonth": return Id_getUTCMonth;
			case "getDate": return Id_getDate;
			case "getUTCDate": return Id_getUTCDate;
			case "getDay": return Id_getDay;
			case "getUTCDay": return Id_getUTCDay;
			case "getHours": return Id_getHours;
			case "getUTCHours": return Id_getUTCHours;
			case "getMinutes": return Id_getMinutes;
			case "getUTCMinutes": return Id_getUTCMinutes;
			case "getSeconds": return Id_getSeconds;
			case "getUTCSeconds": return Id_getUTCSeconds;
			case "getMilliseconds": return Id_getMilliseconds;
			case "getUTCMilliseconds": return Id_getUTCMilliseconds;
			case "getTimezoneOffset": return Id_getTimezoneOffset;
			case "setTime": return Id_setTime;
			case "setMilliseconds": return Id_setMilliseconds;
			case "setUTCMilliseconds": return Id_setUTCMilliseconds;
			case "setSeconds": return Id_setSeconds;
			case "setUTCSeconds": return Id_setUTCSeconds;
			case "setMinutes": return Id_setMinutes;
			case "setUTCMinutes": return Id_setUTCMinutes;
			case "setHours": return Id_setHours;
			case "setUTCHours": return Id_setUTCHours;
			case "setDate": return Id_setDate;
			case "setUTCDate": return Id_setUTCDate;
			case "setMonth": return Id_setMonth;
			case "setUTCMonth": return Id_setUTCMonth;
			case "setFullYear": return Id_setFullYear;
			case "setUTCFullYear": return Id_setUTCFullYear;
			case "setYear": return Id_setYear;
