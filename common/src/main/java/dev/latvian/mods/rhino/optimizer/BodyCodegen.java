...
class BodyCodegen {
    ...
    private void generateGenerator() {
        ...
        addOptRuntimeInvoke("createNativeGenerator",
            "(Ldev/latvian/mods/rhino/NativeFunction;"
                + "Ldev/latvian/mods/rhino/Scriptable;"
                + "Ldev/latvian/mods/rhino/Scriptable;II"
                + ")Ldev/latvian/mods/rhino/Scriptable;"
        );
    ...
    private void generateThrowJavaScriptException() {
        cfw.add(ByteCode.NEW,
            "dev/latvian/mods/rhino/JavaScriptException"
        );
    ...
    private void generateYieldPoint(Node node, boolean exprContext) {
        if (unnestedYields.containsKey(node)) {
            ...
            if (exprContext) {
                ...
                addScriptRuntimeInvoke("getObjectPropNoWarn",
                    "(Ljava/lang/Object;Ljava/lang/String;Ldev/latvian/mods/rhino/Context;"
                        + "Ldev/latvian/mods/rhino/Scriptable;)Ljava/lang/Object;"
                );
            }
            return;
        }
        ...
        if (nestedYield != null) {
            ...
            addScriptRuntimeInvoke("setObjectProp",
                "(Ldev/latvian/mods/rhino/Scriptable;Ljava/lang/String;Ljava/lang/Object;"
                    + "Ldev/latvian/mods/rhino/Context;)Ljava/lang/Object;"
            );
            cfw.add(ByteCode.POP);
    ...
    private void generateLocalYieldPoint(Node node, boolean exprContext) {
        ...
        if (node.getType() == Token.YIELD_STAR) {
            ...
            cfw.add(ByteCode.NEW, "dev/latvian/mods/rhino/ES6Generator$YieldStarResult");
            cfw.add(ByteCode.DUP_X1);
            cfw.add(ByteCode.SWAP);
            cfw.addInvoke(ByteCode.INVOKESPECIAL, "dev/latvian/mods/rhino/ES6Generator$YieldStarResult",
        ...
        if (functionType == FunctionNode.ARROW_FUNCTION) {
            ...
            addOptRuntimeInvoke("bindThis",
                "(Ldev/latvian/mods/rhino/NativeFunction;"
                    ...
                    + "Ldev/latvian/mods/rhino/Scriptable;"
                    + "Ldev/latvian/mods/rhino/Scriptable;"
                    + ")Ldev/latvian/mods/rhino/Function;"
            );
        }
    ...
    private void generateArrayLiteralFactory(Node node, int count) {
        ...
        argsLocal = firstFreeLocal++;
        localsMax = firstFreeLocal;
        cfw.startMethod(methodName, "(Ldev/latvian/mods/rhino/Context;"
                + "Ldev/latvian/mods/rhino/Scriptable;"
                + "Ldev/latvian/mods/rhino/Scriptable;"
                + "[Ljava/lang/Object;"
                + ")Ldev/latvian/mods/rhino/Scriptable;",
    ...
    private void visitSpecialCall(Node node, int type, int specialType,
        ...
        if (type == Token.NEW) {
            ...
            callSignature = "(Ldev/latvian/mods/rhino/Context;"
                + "Ljava/lang/Object;"
                + "[Ljava/lang/Object;"
                + "Ldev/latvian/mods/rhino/Scriptable;"
                + "Ldev/latvian/mods/rhino/Scriptable;"
    ...
    private void visitStandardCall(Node node, Node child) {
        ...
        if (firstArgChild == null) {
            if (childType == Token.NAME) {
                ...
                generateFunctionAndThisObj(child, node);
                methodName = "call0";
                signature = "(Ldev/latvian/mods/rhino/Callable;"
                    + "Ldev/latvian/mods/rhino/Scriptable;"
                    + "Ldev/latvian/mods/rhino/Context;"
                    + "Ldev/latvian/mods/rhino/Scriptable;"
                    + ")Ljava/lang/Object;";
...
*/
        ...
        if (type == Token.NEW) {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                "dev/latvian/mods/rhino/Callable",
                "call",
                "(Ldev/latvian/mods/rhino/Context;"
                    + "Ldev/latvian/mods/rhino/Scriptable;"
                    + "Ldev/latvian/mods/rhino/Scriptable;"
    ...
    private static String exceptionTypeToName(int exceptionType) {
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            return "dev/latvian/mods/rhino/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            return "dev/latvian/mods/rhino/EvaluatorException";
        } else if (exceptionType == ECMAERROR_EXCEPTION) {
            return "dev/latvian/mods/rhino/EcmaError";
    ...
    private class ExceptionManager {
        ...
        private final LinkedList<ExceptionInfo> exceptionInfo;
    }
    ...
    private final IdentityHashMap<Node, String> unnestedYields = new IdentityHashMap<>();
}
