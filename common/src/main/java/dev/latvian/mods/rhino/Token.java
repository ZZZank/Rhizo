...
public interface Token {
	...
	static String typeToName(int token) {
		switch (token) {
			...
			case TEMPLATE_CHARS: return "TEMPLATE_CHARS";
			case TEMPLATE_LITERAL_SUBST: return "TEMPLATE_LITERAL_SUBST";
			case TAGGED_TEMPLATE_LITERAL: return "TAGGED_TEMPLATE_LITERAL";
